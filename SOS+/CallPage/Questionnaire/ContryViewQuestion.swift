...
struct CountryViewQuestion: View {
    ...
    private func autoLocateUser() {
        ...
        default:
            showAlert(title: "Permission Denied", message: "Please enable location services in settings.")
        }
    }

    private func determineLocationAndNavigate() {
