...
struct AusNumberView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                SMSEmergencyButton(emergencyNumber: "000")
                
                Button(action: {
                    // Action for calling the emergency number
                    if let url = URL(string: "tel://000"), UIApplication.shared.canOpenURL(url) {
...
struct AusNumberView_Previews: PreviewProvider {
