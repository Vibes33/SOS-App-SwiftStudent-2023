...
struct EmergencyNumberView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                SMSEmergencyButton(emergencyNumber: "114")
                
                Button(action: {
                    // Action for calling the emergency number
                    if let url = URL(string: "tel://15"), UIApplication.shared.canOpenURL(url) {
...
struct EmergencyNumberView_Previews: PreviewProvider {
